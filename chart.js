...
!(function(t, e) {
				...
				? ((this.valid = !1),
					...
					void ('string' == typeof t
						? (e = d.getRgba(t))
							...
							: (e = d.getHsla(t)) ? this.setValues('hsl', e) : (e = d.getHwb(t)) && this.setValues('hwb', e)
						: 'object' == typeof t &&
	...
	var D = {
			...
			easeInOutExpo: function(t) {
				return 0 === t
					...
					: 1 === t
						? 1
						: (t /= 0.5) < 1 ? 0.5 * Math.pow(2, 10 * (t - 1)) : 0.5 * (2 - Math.pow(2, -10 * --t));
			},
					...
					t.moveTo(e, l),
						s < u && l < d
							...
							: s < u
								...
								: l < d ? (t.arc(s, l, o, -P, 0), t.arc(s, d, o, 0, P)) : t.arc(s, l, o, -P, P),
						t.closePath(),
						t.moveTo(e, n);
				} else t.rect(e, n, i, a);
			},
		...
		updateElement: function(t, e, n) {
			var i = this,
				...
				f =
					n && s.animateRotate
						? 0
						: t.hidden ? 0 : i.calculateCircumference(c.data[e]) * (o.circumference / Nt),
	...
	var Kt = it.extend({
		...
		_resolveDatasetElementOptions: function() {
			...
			return (
				(i.spanGaps = Xt(e.spanGaps, n.spanGaps)), (i.tension = Xt(e.lineTension, n.elements.line.tension)), i
			);
		},
		updateBezierControlPoints: function() {
			var t,
	...
	function $e() {
		return H.merge({}, [].slice.call(arguments), {
			merger: function(t, e, n, i) {
				...
				'scales' === t
					? (e[t] = Ze(a, r))
					: 'scale' === t ? (e[t] = H.merge(a, [ Re.getScaleDefaults(r.type), r ])) : H._merger(t, e, n, i);
			}
		});
	}
	function Xe(t) {
		...
		on = {
			formatters: {
				...
				logarithmic: function(t, e, n) {
					...
					return 0 === t
						? '0'
						: 1 === i || 2 === i || 5 === i || 0 === e || e === n.length - 1 ? t.toExponential() : '';
				}
			}
		},
		sn = H.isArray,
		...
		if (
			!(
				...
				((i =
					1 === a
						? Math.max(o - s, l - o)
						: 0 === e ? (t.getPixelForTick(1) - o) / 2 : (o - t.getPixelForTick(r - 1)) / 2),
			...
			handleTickRangeOptions: function() {
				...
				(t.min = Rn(e.min, t.min)),
					...
					null === t.minNotZero &&
						(t.min > 0
							? (t.minNotZero = t.min)
							: t.max < 1 ? (t.minNotZero = Math.pow(10, Math.floor(In(t.max)))) : (t.minNotZero = 1));
			},
			buildTicks: function() {
				var t = this,
					e = t.options.ticks,
			...
			getLabelForIndex: function(t, e) {
				...
				return (
					...
					r.tooltipFormat
						...
						: 'string' == typeof o ? o : i.format(si(n, o), r.displayFormats.datetime)
				);
			},
		...
		gi = e(function(e, n) {
			e.exports = (function() {
				...
				function Wt(t, e, n) {
					...
					return n
						? 'MMM' === e
							? -1 !== (a = Pt.call(this._shortMonthsParse, o)) ? a : null
							: -1 !== (a = Pt.call(this._longMonthsParse, o)) ? a : null
						: 'MMM' === e
				...
				function Qt(t, e, n) {
					...
					return n
						? 'dddd' === e
							? -1 !== (a = Pt.call(this._weekdaysParse, o)) ? a : null
							: 'ddd' === e
								? -1 !== (a = Pt.call(this._shortWeekdaysParse, o)) ? a : null
								: -1 !== (a = Pt.call(this._minWeekdaysParse, o)) ? a : null
						: 'dddd' === e
								...
								n[bt] < 0 || n[bt] > 11
									...
									: n[yt] < 1 || n[yt] > It(n[vt], n[bt])
										...
										: n[xt] < 0 ||
											...
											: n[_t] < 0 || n[_t] > 59
												? _t
												: n[wt] < 0 || n[wt] > 59 ? wt : n[kt] < 0 || n[kt] > 999 ? kt : -1),
					...
					if (
						('start' === a
							...
							: 'end' === a
								...
								: void 0 !== n.scaleZero ? (r = n.scaleZero) : i.getBasePixel && (r = i.getBasePixel()),
						null != r)
					) {
		...
		for (t.beginPath(), o = 0, s = g; o < s; ++o)
			(d = n((u = e[(l = o % g)]._view), l, i)),
				...
				h && c
					...
					: b &&
						y &&
						(m ? (h && p.push(u), c && v.push(d)) : (wi(t, p, v, b, y), (b = y = 0), (p = []), (v = [])));
